...
public:
    ...
    bool GetDistancesToWalls(float fRayAngle, std::vector<IntersectInfo>& vHitList, Map& map, Player& player);
    ...
    void raycasting(olc::PixelGameEngine& pge, Player& player, Map& map, Sprite& sprite);
